...
- [VideoPrism: A Foundational Visual Encoder for Video Understanding](https://arxiv.org/abs/2402.13217) (Google DeepMind, 2024)
- [Is Space-Time Attention All You Need for Video Understanding? (TimeSformer)](https://arxiv.org/abs/2102.05095) (Meta AI, ICML 2021)
- [Soft-DTW: a Differentiable Loss Function for Time-Series](https://arxiv.org/abs/1703.01541) (Cuturi & Blondel, ICML 2017)
- [Kinetics-400 Dataset](https://arxiv.org/abs/1705.06950)
- [Something-Something V2 Dataset](https://arxiv.org/abs/1706.04261)
- [Gesture Recognition for Note Generation in VR Rhythm Game](https://ieeexplore.ieee.org/document/9333868) — 본 연구의 응용 배경 논문 (ICOIN 2021)
